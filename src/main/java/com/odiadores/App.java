...
public class App extends GUI {
    public static void main(String[] args) throws FileNotFoundException, IOException, ParseException {
        ...
        Iluminacao ledRGB = new Iluminacao("Led da Parede da Sala de TV");
        Iluminacao lampadaCentral = new Iluminacao("Lâmpada Central da Sala de TV");
        ...
        Iluminacao lampadasPrincipais = new Iluminacao("Lâmpadas da Sala de Jantar");
        ...
        Iluminacao lampadaQuartoPrincipal = new Iluminacao("Lâmpada do Quarto Principal");
        Iluminacao luminariaQuartoPrincipal = new Iluminacao("Luminária do Quarto Principal");
